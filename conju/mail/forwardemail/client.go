...
import (
	...
	"github.com/cshabsin/conju/conju/mail"
)
...
func (c *Client) Send(ctx context.Context, m *mail.Message) error {
	...
	msg := &Message{
		...
		Text:    m.Text,
		HTML:    m.HTML,
		CC:      mail.CommaSeparated(m.CC),
		BCC:     mail.CommaSeparated(m.BCC),
	}
